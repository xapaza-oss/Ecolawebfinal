...
export const COURSES_DATA: Course[] = [
  {
    ...
    duration: '8 Semanas',
    hours: 48,
    instructor: 'Dr. Ivan Velásquez Castellanos',
    instructorRole: 'PhD en Economía (.....) - Investigadora Principal',
  ...
  },
  {
    ...
    duration: '6 Semanas',
    hours: 36,
    instructor: 'MSc Osmar Bolivar Rosales',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
  ...
  },
  {
    ...
    instructorRole: 'MBA Jose Miguel Molina',
  ...
  },
  {
    ...
    duration: '6 Semanas',
    hours: 36,
    instructor: 'PhD Ludwing Torres Carrasco',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
    instructorAffiliation: 'Consultor Banco Interamericano de Desarrollo',
    description: 'Puente directo entre la econometría clásica y el machine learning predictivo. Domina manipulación de macrodatos con Polars/Pandas, Regularización (LASSO/Ridge), Bosques Aleatorios y Double Machine Learning.',
    tools: ['Python', 'Pandas', 'Scikit-Learn', 'DoubleML', 'Seaborn'],
  ...
  },
  {
    ...
    duration: '6 Semanas',
    hours: 36,
    instructor: 'Lic Joab Dan Valdivia',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
    instructorAffiliation: 'Consultor Banco Interamericano de Desarrollo',
    description: 'Puente directo entre la econometría clásica y el machine learning predictivo. Domina manipulación de macrodatos con Polars/Pandas, Regularización (LASSO/Ridge), Bosques Aleatorios y Double Machine Learning.',
    tools: ['Python', 'Pandas', 'Scikit-Learn', 'DoubleML', 'Seaborn'],
  ...
  {
    id: 'curso-6',
    title: 'Macroeconométria II: Modelos no lineales',
    level: 'Iniciación',
    track: 'Econometría & Datos',
    duration: '6 Semanas',
    hours: 36,
    instructor: 'MSc Ivan Romero',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
    instructorAffiliation: 'Consultor Banco Interamericano de Desarrollo',
    description: 'Puente directo entre la econometría clásica y el machine learning predictivo. Domina manipulación de macrodatos con Polars/Pandas, Regularización (LASSO/Ridge), Bosques Aleatorios y Double Machine Learning.',
    tools: ['Python', 'Pandas', 'Scikit-Learn', 'DoubleML', 'Seaborn'],
  ...
  {
    id: 'curso-7',
    title: 'ML para pronósticos financieros y macroeconómicos',
    level: 'Iniciación',
    track: 'Econometría & Datos',
    duration: '6 Semanas',
    hours: 36,
    instructor: 'Jhonatan Careres',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
    instructorAffiliation: 'Consultor Banco Interamericano de Desarrollo',
    description: 'Puente directo entre la econometría clásica y el machine learning predictivo. Domina manipulación de macrodatos con Polars/Pandas, Regularización (LASSO/Ridge), Bosques Aleatorios y Double Machine Learning.',
    tools: ['Python', 'Pandas', 'Scikit-Learn', 'DoubleML', 'Seaborn'],
  ...
  },
  {
    ...
    duration: '6 Semanas',
    hours: 36,
    instructor: 'JMSc Vidal Choque Atto',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
    instructorAffiliation: 'Consultor Banco Interamericano de Desarrollo',
    description: 'Puente directo entre la econometría clásica y el machine learning predictivo. Domina manipulación de macrodatos con Polars/Pandas, Regularización (LASSO/Ridge), Bosques Aleatorios y Double Machine Learning.',
    tools: ['Python', 'Pandas', 'Scikit-Learn', 'DoubleML', 'Seaborn'],
  ...
  {
    id: 'curso-10',
    title: 'Taller de Matlab',
    level: 'Iniciación',
    track: 'Econometría & Datos',
    duration: '6 Semanas',
    hours: 36,
    instructor: 'MSc Vidal Choque Atto',
    instructorRole: 'MScen Economía Cuantitativa (.....)',
    instructorAffiliation: 'Consultor Banco Interamericano de Desarrollo',
    description: 'Puente directo entre la econometría clásica y el machine learning predictivo. Domina manipulación de macrodatos con Polars/Pandas, Regularización (LASSO/Ridge), Bosques Aleatorios y Double Machine Learning.',
    tools: ['Python', 'Pandas', 'Scikit-Learn', 'DoubleML', 'Seaborn'],
  ...
  },
  {
    ...
    duration: '6 Semanas',
    hours: 36,
    instructor: 'Lic Addina Gutierrez',
