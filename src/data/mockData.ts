...
export const PROJECTS_DATA: Project[] = [
  {
    id: 'proj-1',
title: 'Determinantes socioeconómicos y familiares del abandono escolar en adolescentes bolivianos mayores de 14 años: un análisis con regresión logística binomial',    authors: [
      { name: 'Ernesto Ayala Attie', email: 'ernestoayalaattie25@gmail.com', institution: 'Programa EcoLab'},
    ],
